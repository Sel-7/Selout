...
NDiplomacy = {
	...
	DEMAND_UNLAWFUL_TERRITORY_DESIRE_AE_MODIFIER = 0,
...
NCountry = {
	...
	BANKRUPTCY_COLONIAL_GROWTH_PENALTY = 0, 		-- growth penalty for bankruptcy
	MAX_NATIONALISM = 10,
	MIN_NATIONALISM = -30,
	...
	RAZE_PROVINCE_DEVELOPMENT_DECREASE = 0.0,
...
NEconomy = {
	...
	CARAVAN_FACTOR = 6.0,							-- Development is divided by this factor, do not set to zero!
...
NAI = {
	...
	ACCEPTABLE_BALANCE_DEFAULT = 1.8, --AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
	ACCEPTABLE_BALANCE_MULT_FRIEND_IN_COMBAT = 0.7,
	...
	AGGRESSIVENESS = 800, -- Base chance (out of 10000) of AI being willing to start a war each diplomatic tick (~1.5 times a month)
	...
	INCOME_SAVINGS_FRACTION = 0.95, -- AI will reserve this amount of their surplus for long-term savings
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 15, -- The higher this number is, the less willing the AI will be to exceed forcelimits
	MILITARISE_FORT_BUDGET_FACTOR = 1.5, --if the country should militarise, multiply fort budget priority by this
	DESIRED_SURPLUS = 0.3, -- AI will aim for having at least this fraction of their income as surplus when they don't have large savings
	DESIRED_DEFICIT = 0.2, -- AI will try to spend this fraction of their money above their target for long term savings.
	EXTRA_SURPLUS_WHEN_NEEDING_BUILDINGS = 0.25, -- AI will aim for having at least this fraction of their income as additional surplus when they need buildings
	MAX_SAVINGS = 40, -- AI will keep a maximum of this * their monthly income in long-term savings
	...
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MAX_MULT = 3, -- AI desire for a province is multiplied by this if it has 0% overextension (not applied to cores)
	...
	DIPLOMATIC_ACTION_KNOWLEDGE_SHARING_ACCEPTANCE_MULT = 100.0, -- AI scoring for knowledge sharing based on willingness to accept it if offered to them
	...
	INVADING_MAX_AWAY_RATIO = 1.45,							-- AI will never send more than this ratio to invade (Measured in strength)
	...
	HOME_FLEET_MAX_RATIO = 0.6,							-- Maximum proportion of warships in home fleet.
	...
	FIRE_ADVISOR_LOAN_REQUIREMENT = 10,							-- AI will not fire advisors until it has this many loans
	...
	BORDER_DISTANCE_SCORE_IMPACT = 5.0,							-- Border <-> province distance impact on province evaluation
	IMPORANT_PROVINCE_THRESHOLD = 0.01,							-- AI will try to defend provinces under threat worth more than this percentage of total development
	...
	MISSIONARY_MAINTENANCE_SHARE = 0.4,							-- The most an AI will spend of its income on a missionary
	...
	RECRUIT_ADVISOR_BASE_AI_DESIRE = 10,						-- AI scoring for redruiting advisors, multiplied by budget/cost
	PROMOTE_ADVISOR_BASE_AI_DESIRE = 10,						-- AI scoring for promoting advisors, multiplied by budget/cost
	...
	ESTATE_PRIVILEGE_REVOKE_THRESHOLD = 7,
	...
	ESTATE_INTERACTION_THRESHOLD = 25.0,
	ESTATE_MAX_WANTED_INFLUENCE = 89.0,
	ESTATE_MIN_WANTED_CROWNLAND = 10.0,
...
NAIEconomy = {
	BUDGETING_ADJUSTMENT_STEP = 0.02,							-- Amount in percent to increase/decrease spending on budget posts when adjusting due to surplus/deficit
...
NGovernment = {
	...
	GOVERNMENT_REFORM_CHANGE_PROGRESS_COST = 40.0,
